...
onload = function() {
    ...
    btnBold.addEventListener("click", function() {
        var inScrollPercent = editor.getScrollInfo().y / editor.getScrollInfo().height;
        var outScrollPercent = document.getElementById("out").scrollTop / document.getElementById("out").scrollHeight;
        alert(inScrollPercent);
        alert(outScrollPercent);
    });
